...
namespace GoldenGames.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^(?:(?:\+|00)351)?9[1236]\d{7}$", ErrorMessage = "Formato invalido, Insira um numero correto")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            //Verificar se email já existe na database e se está confirmado
            ...
            {
                ModelState.AddModelError(string.Empty, "Username já está em uso");
                return Page();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Confirme a sua conta  <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Ao Clicar Aqui</a>.");
